			 ...
			 <tr>
              ...
              <td>
			   <?php 
                 ...
                 if($rowPagina["pagina_dipendenza_id"] == "0"): echo "Pagina Primaria"; 
				 
				 	elseif ($rowPagina["pagina_dipendenza_id"] == "accordion"): 
...
/* CATEGORIA *****************************************************************/
if($pag == "categorie"):  
 /*   $sqlCategoria2 = "SELECT * FROM `categoria`"; 
	$rCategoria2 = $mysqli->query($sqlCategoria2);
	$countCategoria2 = $rCategoria2->num_rows;
   /*  LOOP ACCOUNT ADMIN  
   if($countCategoria >= 1):
	  while ( $rowCategoria2 = $rCategoria2->fetch_array() ):?>
                 <tr>
                  <td><?php echo $rowCategoria2["categoria_nome"]; ?></td>
                  <td><?php echo $rowCategoria2["categoria_url"]; ?></td>
                  <td class="td-center">
                   <div class="btn-toolbar" role="toolbar">
                  	<div class="btn-group" role="group"> 
                     <form class="j-forms formElement"  method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <input class="idSelection" type="hidden" name="categoria_id" value="<?php echo $rowCategoria2["categoria_id"]; ?>" />
                      <button class="btn btn-default btn-sm m-user-delete"><i class="zmdi zmdi-close"></i></button>
                     </form>
                    </div>
                   </div>
