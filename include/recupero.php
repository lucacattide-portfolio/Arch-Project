    ...
    <article class="autenticazione">
        ...
        <form method="post" action="" enctype="application/x-www-form-urlencoded" id="form_recupero" autocomplete="on" title="Login" accept-charset="UTF-8" >
            ...
            <fieldset>
            	...
            	<input name="email_recupero" type="email" required="required" id="email_recupero" form="form_recupero" placeholder="Email" pattern="^[a-z0-9][_.a-z0-9-]+@([a-z0-9][0-9a-z-]+.)+([a-z]{2,4})" tabindex="1" title="Inserire l'indirizzo E-Mail">
            ...
            <input name="entra_recupero" type="submit" id="entra_recupero" form="form_recupero" tabindex="4" title="Accedi" value="Invia">
