        ...
        <form method="post" action="" enctype="application/x-www-form-urlencoded" id="form_registrazione" autocomplete="on" title="Login" accept-charset="UTF-8" >
            ...
            <fieldset>
                ...
                <div>
                    ...
                    <input name="email_registrazione" type="email" required="required" id="email_registrazione" form="form_registrazione" placeholder="Email*" pattern="^[a-z0-9][_.a-z0-9-]+@([a-z0-9][0-9a-z-]+.)+([a-z]{2,4})" tabindex="3" title="Inserire l'indirizzo E-Mail" class="animated fadeInLeft">
                    <input name="telefono_registrazione" type="tel" form="form_registrazione" id="telefono_registrazione" placeholder="Telefono" tabindex="4" title="Inserire il telefono" class="animated fadeInRight">
                ...
                <div>
                  ...
                  <input name="fiscale_registrazione" type="text" required="required" id="fiscale_registrazione" form="form_registrazione" placeholder="Codice Fiscale*" tabindex="9" title="Inserire il codice fiscale" maxlength="16" class="animated fadeInLeft">
                  <input name="iva_registrazione" type="text" id="iva_registrazione" form="form_registrazione" placeholder="Partita IVA" tabindex="10" title="Inserire la partita IVA" class="animated fadeInRight">
              
                </div>
                <div>
              
                  <input name="password_registrazione" type="text" required="required" id="password_registrazione" form="form_registrazione" placeholder="Password*" tabindex="11" title="Inserire la password" class="animated fadeInLeft">
                  <input name="password_conferma_registrazione" type="text" required="required" id="password_conferma_registrazione" form="form_registrazione" placeholder="Conferma Password*" tabindex="12" title="Confermare la password" class="animated fadeInRight">
            ...
            <div>
            	...
            	<span>
                    ...
                    <label for="accettazione" class="animated fadeInUp">
                    
                        <input name="accettazione" type="checkbox" required="required" id="accettazione" form="form_registrazione" title="Accettare i termini e le condizioni" tabindex="13" class="animated fadeInUp">
            	...
            	<input name="entra_registrazione" type="submit" id="entra_registrazione" form="form_registrazione" tabindex="14" title="Accedi" value="Registrati" class="animated fadeInUp">
